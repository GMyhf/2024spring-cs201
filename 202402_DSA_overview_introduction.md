...
没有固定教材，会全面介绍在经典计算机科学问题中出现的数据结构与算法。尽管在学习顺序上并无严格要求，但是许多话题之间都存在一定的依赖关系，所以建议顺序学习。下表是16周的课程内容安排： 
...
assignment1.md, assignmentP.md, at https://github.com/GMyhf/2024spring-cs201
